...
\begin{itemize}
    \item Explore role of cellular aneuploidy in placental development in humans
\end{itemize}
\end{CVSection}
\begin{CVSection}
...
\begin{itemize}
\item Organized recruitment events for PhD program applicants
\item Coordinated orientation events for matriculating students
\item Organized meetings and resources for student council members
\end{itemize}
\end{CVSection}
\begin{CVSection}
\textbf{Colgate University}, Hamilton, NY\\
