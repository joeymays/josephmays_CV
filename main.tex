\documentclass[10pt, letterpaper]{article} %set normal font size, everything is set relative to this
...
\usepackage[sfdefault]{noto} %noto sans fonts
\usepackage{enumitem} %for space between list items
\setlist[itemize]{noitemsep, topsep=0pt, partopsep=0pt}

\renewcommand\labelitemi{$\circ$} %bullet for list items 

\usepackage{microtype} % manages line breaks, solved issue where margins were broken
...
%\CVListOneLine{GRO Your Career.}{GRO-Biotech, New York, NY, October 2020.}
