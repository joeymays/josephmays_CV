...
PhD, Genome Integrity Training Program\\
Cumulative GPA: 3.87
\end{CVSection}
\begin{CVSection}
...
Topics in Molecular Biology & A & Mammalian Stem Cells in Disease and Regeneration & P\\
Introduction to Research & A & Fundamental Research Skills \& Tools & P\\
Developmental and Stem Cell Systems I & A-\\
\end{tabular}
\end{CVSection}
